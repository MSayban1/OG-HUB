  ...
  return (
    <div className="fixed inset-0 bg-slate-950 flex flex-col items-center justify-center z-[100]">
      <div className="relative mb-6">
        <div className="absolute -inset-8 bg-indigo-500 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <img 
          src={LOGO_URL} 
          alt={APP_NAME} 
      ...
      <h1 className="text-4xl font-extrabold tracking-tighter text-slate-50 mb-2">
        {APP_NAME}
      </h1>
      <p className="text-indigo-400 font-medium tracking-wide text-sm opacity-80">
        {TAGLINE}
      </p>
      
      <div className="absolute bottom-12 flex flex-col items-center">
        <div className="w-48 h-1 bg-slate-800 rounded-full overflow-hidden">
          <div className="h-full bg-indigo-500 w-1/3 animate-[loading_2s_infinite_linear]"></div>
        </div>
