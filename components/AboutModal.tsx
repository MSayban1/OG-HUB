    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-slate-900 w-full max-w-md rounded-[3rem] border border-slate-800 overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.5)] relative animate-page-transition">
        <div className="p-8 pb-4 flex items-center justify-between">
           <h4 className="text-2xl font-black text-slate-50 tracking-tighter">Mission Control</h4>
        ...
        <div className="px-8 pb-10 space-y-8 overflow-y-auto max-h-[80vh] scrollbar-hide">
           ...
           <div className="space-y-6">
              <div className="p-6 bg-slate-950/50 rounded-[2rem] border border-slate-800/50 space-y-4 text-center group hover:border-indigo-500/30 transition-all">
                 <p className="text-[10px] font-black uppercase tracking-widest text-indigo-500">Corporate Visionary</p>
                 <img 
                 ...
                 />
                 <h5 className="font-black text-slate-50 text-sm uppercase tracking-widest">Saban Productions</h5>
              </div>

              <div className="p-6 bg-slate-950/50 rounded-[2rem] border border-slate-800/50 space-y-4 text-center group hover:border-indigo-500/30 transition-all">
                 <p className="text-[10px] font-black uppercase tracking-widest text-indigo-500">Development Authority</p>
                 <img 
                   src="https://i.postimg.cc/bSXKvyqY/saban-games.png" 
                   alt="Saban Games" 
                   className="h-16 mx-auto object-contain filter drop-shadow-[0_0_10px_rgba(255,255,255,0.1)] group-hover:scale-105 transition-transform"
                 />
                 <h5 className="font-black text-slate-50 text-sm uppercase tracking-widest">Saban Games</h5>
              </div>
           </div>
